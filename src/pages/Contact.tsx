...
const Contact = () => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Absolutely. We are fully licensed and carry comprehensive insurance coverage to protect our clients and properties."
    },
    {
      ...
      <section className="py-20 bg-gradient-to-br from-green-900 via-green-800 to-green-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button 
              size="lg" 
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-green-900 text-lg px-8 py-3"
            >
