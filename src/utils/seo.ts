...
export const defaultSEO: SEOProps = {
  title:
    "All In One Residential & Commercial Services LLC - Managing Homes, Simplifying Lives",
  description:
    "All In One Residential & Commercial Services LLC provides professional property management, cleaning, staging, lawn care, and more. Serving Tampa Bay Area with excellence.",
  keywords:
